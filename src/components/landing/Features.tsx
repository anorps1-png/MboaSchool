  ...
  const features = [
    {
      ...
      description: "Base de données centralisée pour suivre facilement les effectifs, les dossiers, les classes et les présences.",
      icon: (
    ...
    {
      title: "Suivi de la Trésorerie & Facturation",
      description: "Séparez clairement la Facturation Globale (CA constaté en engagement) et la Trésorerie réellement perçue (avances, acomptes). Évitez les écarts de caisse.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Dashboard de Recouvrement",
      description: "Visualisez en un coup d'œil le taux de recouvrement global et par classe via des mini-indicateurs de progrès circulaires (donuts) pour cibler vos relances.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Comptabilité OHADA & Taxes",
      description: "Saisie des dépenses, constatation des charges et calcul de la fiscalité camerounaise (CNPS, CAC, CFC, FNE, TVA) sur les fiches de paie.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Sécurité & Isolation Multi-Établissement",
      description: "Grâce aux politiques RLS de Supabase, chaque établissement est hermétiquement cloisonné. Aucun risque de conflit de données, même lors d'importations simultanées.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "Imports/Exports Excel Robustes",
      description: "Importez massivement vos listes d'élèves et de notes. Notre système robuste gère intelligemment les ré-importations et évite la création de doublons.",
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
